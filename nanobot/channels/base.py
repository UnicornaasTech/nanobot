...
class BaseChannel(ABC):
    ...
    async def _handle_message(
        ...
        When *no_reply* is True, the agent loop may persist the turn without
        generating a reply.  When *is_dm* is True, denied senders receive a
        pairing code instead of silence.
        """
