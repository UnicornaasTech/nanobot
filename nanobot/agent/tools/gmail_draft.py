...
class CreateGmailDraftTool(Tool, ContextAware):
    ...
    description = (
        ...
        "automatically as a heads-up (header) plus a threaded reply with the customer email "
        "and your final answer. After success, put only a brief 1-2 sentence summary in your "
        "final reply. On errors, put the error explanation in your final reply too — the same "
        "deterministic post will surface it. The message() tool is suppressed in email sessions "
        "to avoid duplicate posts; do not call it. "
        "Note: You cannot use markdown-kind of formatting such as **bold** or *italic* in message body, as it will not be rendered properly in the email."
        "Do not repeat draft IDs or raw API fields. "
